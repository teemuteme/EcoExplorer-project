...
import fi.tuni.application.classes.DailyHistoryData.Clouds;
import fi.tuni.application.classes.DailyHistoryData.Snow;

import java.util.List;

@JsonIgnoreProperties(ignoreUnknown = true)
public class HourlyHistoryData {
    ...
    public static class HourlyWeatherInfo {
        ...
        public DailyHistoryData.Clouds getClouds() {
            return clouds;
        }

        public void setClouds(DailyHistoryData.Clouds clouds) {
            this.clouds = clouds;
        }
        ...
        public FeelsLike.Rain getRain() {
            return rain;
        }

        public void setRain(FeelsLike.Rain rain) {
            this.rain = rain;
        }

        public DailyHistoryData.Snow getSnow() {
            return snow;
        }

        public void setSnow(DailyHistoryData.Snow snow) {
            this.snow = snow;
        }
